# invitacion-placeholders Specification

## Purpose

Marcadores y primitivos de assets pendientes de la invitación de XV años: el primitivo `Photo`, el primitivo `Ornamento` y los símbolos de icono en `public/icons.svg`.
