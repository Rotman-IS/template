# cuenta-regresiva Specification

## Purpose

Cuenta regresiva en vivo hasta la fecha del evento dentro de la invitación de XV años: unidades mostradas, comportamiento al vencerse, limpieza del intervalo y fuente única de la fecha.
