# invitacion-estructura Specification

## Purpose

Estructura de la aplicación de la invitación de XV años: composición de secciones en `App.tsx`, conservación comentada del landing anterior y contenedor de ancho móvil.
