# invitacion-estilo Specification

## Purpose

Sistema visual de la invitación de XV años: paleta lavanda sobre crema en tokens, ausencia de modo oscuro, roles tipográficos y organización del CSS.
